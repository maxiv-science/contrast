...
class Flyscan(Mesh):
    """
    Flyscan macro for the Npoint LC400 + PandABox setup.
        
    flyscan <fly-motor> <start> <stop> <intervals> <step-motor1> <start1> <stop1> <intervals1> ... <exp time> <latency>
    ...
    def __init__(self, *args):
        ...
        try:
            ...
            super(Flyscan, self).__init__(*args[4:-1])
